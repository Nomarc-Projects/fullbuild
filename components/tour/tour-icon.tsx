 ...
 * renders it inside a yellow-tinted disc with a gentle, looping animation.
 *
...
export const TOUR_ICONS = {
  ...
  gauge: Gauge,
  handshake: Handshake,
  // Nomarc's own glyph — same call signature as a lucide icon.
  helm: HelmIcon as unknown as LucideIcon,
  inbox: Inbox,
  kanban: KanbanSquare,
  layout: LayoutGrid,
  lifeBuoy: LifeBuoy,
...
/**
 * Animated step icon. Renders the glyph in a Nomarc-yellow disc with a soft halo
  ...
  return (
    <span
      className={cn(
        ...
        "bg-[#fff7cc] text-[#8a6d00] dark:bg-[#ffd716]/10 dark:text-[#ffd716]",
        className,
      )}
    >
      {!reduced && (
        <motion.span
          aria-hidden
          className="absolute inset-0 rounded-full bg-[#ffd716]/25"
