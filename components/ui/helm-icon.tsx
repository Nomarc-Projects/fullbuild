/**
 * Helm mark — the brain glyph, drawn with `currentColor` so it inherits the
 * surrounding text colour and reads correctly in both light and dark mode.
 * Shared by both AI surfaces: the Helm consultant (dashboard page + sidebar
 * nav entry) and the public Helm FAB on the marketing site.
 */
export function HelmIcon({ className, size }: { className?: string; size?: number | string }) {
  return (
    <svg
      viewBox="0 0 256 256"
      className={className}
